...
Route::post('register-invite', [RegisterInviteController::class, 'register_invite'])->name('register-invite');
Route::get('/', [RegisterInviteController::class, 'register_attendees'])->name('register-attendees');
Route::get('thank-you/{rsvp_id}', [RegisterInviteController::class, 'thank_you'])->name('thank-you');
